...
#ifndef TEST_MSGS__MSG__DETAIL__DATA_MESSAGE1__TRAITS_HPP_
#define TEST_MSGS__MSG__DETAIL__DATA_MESSAGE1__TRAITS_HPP_
...
inline std::string to_yaml(const DataMessage1 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const test_msgs::msg::DataMessage1 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const test_msgs::msg::DataMessage1 & msg)
{
  return test_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<test_msgs::msg::DataMessage1>()
{
  return "test_msgs::msg::DataMessage1";
}

template<>
inline const char * name<test_msgs::msg::DataMessage1>()
{
  return "test_msgs/msg/DataMessage1";
}

template<>
struct has_fixed_size<test_msgs::msg::DataMessage1>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<test_msgs::msg::DataMessage1>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<test_msgs::msg::DataMessage1>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TEST_MSGS__MSG__DETAIL__DATA_MESSAGE1__TRAITS_HPP_
